% from 32:38 to 1:49:30
    clc;
    clear;
    close all;

%% Adding Essential Folders
    current_Folder_Address = pwd;
    target_Folder_Address = strcat( current_Folder_Address, '\GA' );
    addpath( target_Folder_Address );
    
%% Problem Definition
    data=B1_LoadData();
    CostFunction=@(s) B2_FeatureSelectionCost(s,data);     % Cost Function
